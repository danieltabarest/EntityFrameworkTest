...
namespace EntityFrameworkTest.Controllers
{
    ...
    public class LeaguesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "LeagueId,Name,Log")] League league)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "LeagueId,Name,Log")] League league)
        {
            if (ModelState.IsValid)
            {
